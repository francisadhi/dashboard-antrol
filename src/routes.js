...
//Master Data
const Pasien = React.lazy(() => import('./views/master/pasien/Pasien'))
// const Master = React.lazy(() => import('./views/master/pasien/Master'))
// const Transaksi = React.lazy(() => import('./views/master/pasien/Transaksi'))
...
const ListBooking = React.lazy(() => import('./views/transaksi/Booking'))
const ListRegistrasi = React.lazy(() => import('./views/transaksi/Pendaftaran'))
const routes = [
  ...
  // { path: '/master/pasien', name: 'Pasien', component: Pasien },
  // { path: '/master/layanan', name: 'Layanan', component: Layanan },
  ...
  { path: '/transaksi', name: 'Transaksi', component: Colors, exact: true },
  { path: '/transaksi/list-booking', name: 'Daftar Booking', component: ListBooking },
  { path: '/transaksi/list-pendaftaran', name: 'Daftar Registrasi', component: ListRegistrasi },
  { path: '/master', name: 'Master', component: Colors, exact: true },
  { path: '/master/list-jadwal', name: 'Daftar Jadwal Dokter', component: Jadwal },
  { path: '/master/list-layanan', name: 'Daftar Layanan', component: Layanan },
